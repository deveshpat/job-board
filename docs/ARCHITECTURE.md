...
How the job board works under the hood — for developers and the curious. Users: see the [README](../README.md).
...
2. **Profile**: upload your resume (PDF or LaTeX) or build one in the editor. The engine picks your
